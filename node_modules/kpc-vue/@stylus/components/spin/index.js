...
import './index.styl';
var Spin = (_dec = Intact.template(), (_class = (_temp = _class2 = /*#__PURE__*/function (_Intact) {
  _inheritsLoose(Spin, _Intact);
  ...
  return Spin;
}(Intact), _defineProperty(_class2, "template", template), _defineProperty(_class2, "blocks", ['canvas']), _defineProperty(_class2, "propTypes", {
