...
var Card = (_dec = Intact.template(), (_class = (_temp = _class2 = /*#__PURE__*/function (_Intact) {
  _inheritsLoose(Card, _Intact);
  ...
  return Card;
}(Intact), _defineProperty(_class2, "template", template), _defineProperty(_class2, "blocks", ['header', 'title', 'extra']), _defineProperty(_class2, "propTypes", {
