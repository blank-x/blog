...
var Select = (_dec = Intact.template(), (_class = (_temp = _class2 = /*#__PURE__*/function (_Intact) {
  ...
  _proto.defaults = function defaults() {
    return {
      ...
      filter: function filter(keywords, props) {
        ...
        if (keywords == null || props.label && ~_indexOfInstanceProperty(_context = props.label.toLowerCase()).call(_context, tmp = keywords.toLowerCase()) || isStringOrNumber(props.value) && ~_indexOfInstanceProperty(_context2 = String(props.value).toLowerCase()).call(_context2, tmp)) {
          valid = true;
        }
  ...
  _proto._onSearch = function _onSearch(e) {
    ...
    this.set('keywords', _trimInstanceProperty(_context3 = e.target.value).call(_context3)); // always show menu on searching
  ...
  _proto._delete = function _delete(value, e) {
    ...
    var values = _sliceInstanceProperty(_context4 = this.get('value')).call(_context4, 0);
